    ...
    for cat in dic:
        for num in dic[cat]:
            ...
            for entry in sen_dic:
                ...
                title=Clean_Text(sen_dic[entry]['title'])
                body=Clean_Text(sen_dic[entry]['body'])
                ...
                if not found_in_title:
                    ptitle,ptitle_phoneme=getkbtemplate(bt,g2p,title)
                    if ptitle!=title:
                        found_in_title=True
                if not found_in_body:
                    pbody,pbody_phoneme=getkbtemplate(bt,g2p,body)
                    if pbody!=body:
                        found_in_body=True
